...
// const VAPI_PUBLIC_KEY = '0fe0887c-301c-483a-ac3e-8227707f2a85';
// const VAPI_ASSISTANT_ID = '63ece4ac-a4b4-43ff-b2dd-d06b2dc4fb77';
...
//   async startCall(systemPrompt: string) {
//     try {
//       const call = await this.vapi.start(VAPI_ASSISTANT_ID);
//       return call;
//     } catch (error) {
